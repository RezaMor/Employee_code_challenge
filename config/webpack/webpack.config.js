...
function mergeConfig(mergeOptions) {
  ...
  config.entry = {
    'exercises': [
      './modules/code-challenge/app.js',
      './modules/code-challenge/app.styl'
    ]
  };
...
// END_CONFIT_GENERATED_CONTENT
  ...
  // Modify the CSS loader to support Bootstrap
  cssLoaderOptions.paths = 'node_modules/bootstrap-styl';

  config.module.rules.push({
    test: helpers.pathRegEx(/glyphicons.*\.(eot|otf|svg|ttf|woff|woff2)$/),
    use: 'file-loader?name=/assets/bootstrap/font/[2].[hash:8].[ext]'
  });
